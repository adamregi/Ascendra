...
class AppColors {
  ...
  static const primary = Color(0xFF2D332E);
  static const secondary = Color(0xFF8A9A8E);
  static const tertiary = Color(0xFF3A2F30);
  static const neutral = Color(0xFF787776);

  static const accentWarm = Color(0xFFD4AF37);
  static const success = Color.fromARGB(
    255,
    52,
    108,
    67,
  ); // Reusing secondary for healthy status
  static const warning = Color(0xFFD4AF37); // Reusing accentWarm
  static const error = Color(0xFFba1a1a);

  // Surfaces
  static const background = Color(0xFFFFFFFF);
  static const surface = Color(0xFFFCF9F7);
  ...
  // Fixed Colors
  static const secondaryFixed = Color(0xFFd6e7d9);
  static const secondaryFixedDim = Color(0xFFbacbbe);
  ...
  static const outlineVariant = Color(0xFFc4c7c2);

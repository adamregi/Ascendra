...
class ExecutiveOverviewCard extends StatelessWidget {
  ...
  const ExecutiveOverviewCard({super.key, required this.data, this.onRetry});
  ...
  Widget _buildSuccessState(
    ...
    ExecutiveOverviewModel overview,
  ) {
    return Column(
      ...
      children: [
        ...
        if (overview.pendingActions != null &&
            overview.pendingActions!.total > 0)
          AppCard(
  ...
  Widget _buildKpiCard(
    ...
    final semanticLabel =
        '$title is $value. ${trend != null ? "Trend is $trend." : ""}';
    return Semantics(
      label: semanticLabel,
      button: false,

...
import 'package:distributor_os/features/meetings/domain/entities/replay_view_model.dart';
...
void main() {
  ...
  testWidgets(
    'MeetingReplayPage renders and shows metadata and attendance report',
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
            meetingReplayProvider(
              'test-meeting-id',
            ).overrideWith((ref) => Future.value(mockReplayData)),
          ],
